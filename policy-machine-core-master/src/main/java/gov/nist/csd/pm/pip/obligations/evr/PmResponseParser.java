...
public class PmResponseParser implements ResponseParser {
    ...
    public ResponsePattern parse(Map map) throws EVRException {
        ...
        if(map.containsKey("filters")){
            List filterList = getObject(map.get("filters"), List.class);
            //responsePattern.addFilter(filterList.get("filter").toString());
            for (Object a : filterList){
                String filtersString = getObject(a, String.class);
                responsePattern.addFilter(filtersString);
            }
        }
    ...
    private String parseFilter(Map map) throws EVRException{
        String filter = "";
        filter = getObject(map.get("filter"), String.class);
        return filter;
    }
